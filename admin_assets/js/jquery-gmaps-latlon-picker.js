	...
	var publicfunc = {
		...
		init : function(object) {
			...
			autocomplete.addListener('place_changed', function() {
			  _self.vars.marker.setVisible(false);
			...
			if (navigator.geolocation) {
			  navigator.geolocation.getCurrentPosition(function(position) {
				    if($(_self.vars.cssID + ".gllpLatitude").val() == '' || $(_self.vars.cssID + ".gllpLatitude").val() == '0'){
						$(_self.vars.cssID + ".gllpLatitude").val(position.coords.latitude);
						$(_self.vars.cssID + ".gllpLongitude").val(position.coords.longitude);
						var lat = $(_self.vars.cssID + ".gllpLatitude").val();
						var lng = $(_self.vars.cssID + ".gllpLongitude").val();
						var latlng = new google.maps.LatLng(lat, lng);
						_self.vars.map.setZoom( parseInt( $(_self.vars.cssID + ".gllpZoom").val() ) );
