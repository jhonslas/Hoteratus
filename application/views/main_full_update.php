...
?>
 <div class="col-md-6 col-sm-6">
		...
		<input color= type="text" class="form-control widh" value="<?php echo $curr_date;?>" id="datepicker_full_start" name="datepicker_full_start">
 </div>
 </div>
 ...
 <div class="col-md-6 col-sm-6">
  ...
  <div class="form-group">
    <input color type="text" class="form-control widh" value="<?php echo $add_date;?>" id="datepicker_full_end" name="datepicker_full_end">
  </div>
            ...
            $("#datepicker_full_start").datepicker({
               dateFormat: 'yy-mm-dd',
                onSelect: function (selected) {
                    ...
                    $("#datepicker_full_end").datepicker("option", "minDate", dt);
                }
            });
