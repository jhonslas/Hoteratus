...
<style type="text/css" media="screen">
      ...
      .cont {
        position: relative;
        height: 100%;
        background-image: url("<?php echo base_url();?>user_asset/images/slider-2.jpg");
  ...
  <div class="demo">
    <div class="login">
      <div style="padding-top: 100px;">
         <center> <img  src="<?php echo base_url();?>user_assets/images/logo.png" alt="Logo"/> </center>
      </div>
      <div  id="msguser" class="alert alert-danger" style="display: none; text-align: center; font-size: 14px;">
      ...
      <div class="login__form">
        ...
        <p class="login__signup">Don't have an account? &nbsp;<a href="<?=base_url()?>channel/signup">Sign up</a></p>
      </div>
    </div>
...
$(document).ready(function() {
  ...
  $(document).on("click", ".login__submit", function(e) {
    ...
    var data = { "login_email": $("#username").val(), "login_pwd": $("#password").val() };
