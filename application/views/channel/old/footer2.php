...
<?php } ?>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDv3fAYIfLl5H6SmuZKJtUIx6MyNn9xDbs&libraries=places" type="text/javascript"></script>
...
<?php echo theme_js('moment-with-locales.js', true);?>
<?php echo theme_js('bootstrap-datetimepicker.js', true);?>
</div>
</div>
</div>
</body>
