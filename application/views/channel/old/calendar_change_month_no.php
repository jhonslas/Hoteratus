...
<input type="hidden" name="cur_months" id="next_months" value="<?php echo $nr_pr_date+1;?>" />
...
<a class="btn btn-default" href="javascript:;" role="button" data-toggle="modal" data-target="#myModal-ps">Customize calendarFF</a>
</div>

<div class="col-md-3 col-sm-3 bor-o">

<a href="javascript:;" class="pull-left mar-right prev_months <?php if($nr_pr_date==date('m')){?> display_none <?php } ?>" current-channel="<?php echo $con_ch;?>" current-rate="<?php echo $rate_id;?>"><img src="<?php echo base_url();?>user_assets/images/pre.png"></a>
<div class="dropdown pull-left">
  <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu_item1_<?php echo $con_ch;?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
<?php 
...
?>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1" id="ajax_cal_<?php echo $con_ch;?>">
  <?php 
for ($m=$start; $m<=$inc_mnth; $m++) {
	?>
    <li class="<?php if($nr_pr_date==$m) { ?>active<?php } ?> change_months"  current-channel="<?php echo $con_ch;?>" custom="<?php echo $m;?>"><a href="javascript:;" ><?php echo date('F Y', mktime(0,0,0,$m, 1, date('Y'))); //echo date('F Y', mktime(0,0,0,$m));?></a></li>
    <?php } ?>
   </ul>
</div>
<a href="javascript:;" class="pull-left mar-left next_months <?php if($nr_pr_date<date('m')){?> display_none <?php } ?>" current-channel="<?php echo $con_ch;?>"current-rate="<?php echo $rate_id;?>"><img src="<?php echo base_url();?>user_assets/images/next.png"></a>
