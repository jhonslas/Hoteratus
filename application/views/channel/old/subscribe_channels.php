      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel" align="center">Select up to <?php echo ($plan_details['number_of_channels']==99?"Unlimited":$plan_details['number_of_channels'])?> channels to connect your hotels.</h4>
      </div>
...
<input type="hidden" value="<?php echo insep_encode($plan_details['plan_id']);?>" name="check_plan"/>
...
$('#select_channels_subscribe').validate({
			rules :
			{
