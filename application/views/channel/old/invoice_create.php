                    ...
                    <div class="col-xs-8">
					  ...
					  //print_r($hotel_details);
                        ...
                        <!--img src="data:image/png;base64,<?php echo base64_encode(file_get_contents("uploads/logo/".$site_logo));?>" class="img img-responsive hidden-prints" -->
                         <strong><?php echo ucfirst( (isset($bill_details['company_name'])?$bill_details['company_name']:""));?> ,</strong><br>
                        <?php echo (isset($bill_details['address'])?$bill_details['address']:"") ;?> ,<br>
                        ...
                        <?php echo (isset($bill_details['email_address'])?$bill_details['email_address']:'');?> ,</a><br>
                        <abbr title="Phone"></abbr> <?php echo (isset($bill_details['mobile'])?$bill_details['mobile']:'') ;?> ,<br>
                        <strong>VAT:</strong> <?php echo (isset($bill_details['vat'])?$bill_details['vat']:'');?> .
                        </address>
