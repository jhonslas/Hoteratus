...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <a aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button" id="btnGroupDrop1"> Dropdown  <span class="caret"></span>
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <form action="<?php echo lang_url(); ?>reservation/reservation_room" method="post" id="pass_field">
  ...
  ?>
    <div class="input-group">
      ...
      <input type="text" class="form-control" id="dp1" value="<?php echo $current_date; ?>">
    </div>
  </div>
  ...
  <div class="form-group box-p">
    <div class="input-group">
      ...
      <input type="text" class="form-control" id="dp1-p" value="<?php echo $end_date; ?>">
    </div>
  </div>
  <div class="form-group box-p2">
  ...
  <option value="<?php echo $i; ?>"><?php if($i == '1'){echo $i.'adult';}else{echo $i.'adults';} ?></option>
	<?php } ?> 
      ...
      <div class="modal-footer">
        <button type="submit" data-toggle="modal" data-target="#myModal3" class="btn btn-warning">Search</button>
      </div>
	  </form>
    </div>
  </div>
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">  Oct 15 - Oct 16 (1 Nights) – 1 Rooms, 1 Guests
 </h4>
      </div>
      <div class="modal-body">
      <div class="room_info">
      ...
      <div><a href="#"><img src="assets/images/ligh-7.jpg" class="img-responsive" alt=""></a></div>
      </div>
     ...
     <button class="btn btn-info" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">    Room Description </button>
      ...
      <h6>Avg. per night</h6>
      <h2>₨200</h2>
      <button type="button" class="btn btn-info"> Book This Room</button>
...
<div class="more-info" style="display: block;">
    ...
    <div class="clear20"></div>
      ...
      <div class="miSummary">
    <ul>
      <li>Check-in date<span> Oct 15, 2015</span></li>
      <li>Check-out date<span> Oct 16, 2015</span></li>
      <div class="clear10"></div>
      <li>Rooms<span>1</span></li>
      <li>Guests<span>1</span></li>
      <li>Nights<span>1</span></li>
      <div class="clear10"></div>
      <li><b>Total</b><span><b> ₨200</b></span></li>
    </ul>
  </div>
...
<div class="clear"></div>
    ...
    <div class="clear15"></div>
     ...
     <button class="btn btn-info" type="button" data-toggle="collapse" data-target="#collapseExamples" aria-expanded="false" aria-controls="collapseExample">    Room Description </button>
...
<div class="clear"></div>
    ...
    <div class="clear15"></div>
     ...
     <button class="btn btn-info" type="button" data-toggle="collapse" data-target="#collapseExampled" aria-expanded="false" aria-controls="collapseExample">    Room Description  </button>
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <hr>
     <div align="center"> <button type="button" class="btn btn-info text-center"data-toggle="modal" data-target="#thanks_booking"> Complete Booking </button> </div>
      <hr>
...
<div class="modal fade" id="thanks_booking" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <h5> Thank you priya lal, your booking is complete!
