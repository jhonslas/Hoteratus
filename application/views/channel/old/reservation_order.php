...
<div class="contents">
                              ...
                              <div class="portlet light">
                                    ...
                                    <div class="portlet-title clearfix">
                                          ...
                                          <?php if(user_type()=='1' || user_type()=='2' && in_array('2',user_edit()) || admin_id()!='' && admin_type()=='1'){ ?>
                                                <div class="btn-group">
                                                      <a class="btn blue-hoki btn-circle" href="<?php echo lang_url(); ?>reservation/reservation_print/<?php echo $curr_cha_id.'/'.insep_encode($room->reservation_id); ?>" target="_blank">
                                          ...
                                          <div class="tab-pane active" id="tab_1"> 
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                                <div class="portlet blue-hoki box">
                                                                      <div class="portlet-title">
                                                                          ...
                                                                          <div class="actions">
                                                                          <a href="#myModal_autocomplete7" role="button" class="btn btn-default" data-toggle="modal">
                                                                      ...
                                                                      <div class="portlet-body">
                                                                                ...
                                                                                <div class="row static-info">
                                                                                          ...
                                                                                          <div class="col-md-7 value">
                                                                                                ...
                                                                                                <select name="RoomNumber" class="col-md-7 value" id="RoomNumber" onchange="change_roomnumber('<?php echo $room->reservation_code; ?>' ,'<?php echo "0"; ?> ',this.value);">

                                                                                                <?php 



                                                                                                $RoomNumbers = $this->db->query('select b.existing_room_number from 
                                                                                                                        manage_reservation a
                                                                                                                        left join manage_property b on a.room_id = b.property_id
                                                                                                                        WHERE reservation_code='.$room->reservation_code.' and a.hotel_id ='.hotel_id())->row()->existing_room_number;
                                                                                                ...
                                                                                                <option value="<?php echo $det; ?>" <?php if($det==(isset($room->RoomNumber)?$room->RoomNumber:'Unassigned room number')){ echo 'selected="selected"'; }?>><?php echo $det?></option>
                                                      ...
                                                      <div class="col-md-6 col-sm-12">
                                                            <div class="portlet blue-hoki box">
                                                                  <div class="portlet-title">
                                                                        ...
                                                                        <textarea onblur="return update_note('<?php echo $room->reservation_id; ?>',this.value)" class="form-control maxlength-handler" rows="4" name="description" maxlength="1000" ><?php echo $room->description; ?></textarea>
                                                      ...
                                                      <div class="col-md-6">
                                                            <div class="well">
                                                                  ...
                                                                  <div class="row static-info align-reverse">
                                                                        ...
                                                                        ?>
                                                                        <div class="col-md-3 value">
                                                                        <?php echo $currency.$add; ?> 
                                                                        </div>
                                                                        <?php } }
                                                                        else
                                                                        { ?>
                                                                        <div class="col-md-3 value">
                                                                        <?php echo $currency.$add=0; ?> 
                                                                        </div>
                                                                  ...
                                                                  <div class="row static-info align-reverse">
                                                                        ...
                                                                        <div class="col-md-3 value">
                                                                        <?php echo $currency.$subtotal * $tax_price / 100;?> 
                                                                        </div>
                                                                        <?php } }
                                                                        else
                                                                        {
                                                                  ...
                                                                  <div class="row static-info align-reverse">
                                                                        ...
                                                                        <div class="col-md-3 value">
                                                                        <?php echo $currency;?>  <?php echo $subtotal * $tax_price / 100;?> 
                                                                        </div>
                                                                  <?php } } } ?>
                                                                  </div> 
                                                                  <div class="row static-info align-reverse">
                                                                                        ...
                                                                                        <table class="table table-hover table-bordered table-striped">
                                                                                              ...
                                                                                              <tbody> 
                                                                                                    ...
                                                                                                    <tr>
                                                                                                          ...
                                                                                                          <td><?php echo $currency.$payment->paid_amount; ?> 
                                                                                                          </td>
                                                                                                          <td>
                                                                                                                <span class="label label-sm label-success">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                          ...
                                                                                                          <td><input type="hidden" name="total_amount" id="total_amount" value="<?php echo $tot; ?>"><?php echo $currency.$tot; ?> </td>
                                                ...
                                                <div class="col-md-12 col-sm-6">
                                                      ...
                                                      <div class="col-md-6 col-sm-6"> 
                                                            ...
                                                            <input type="text" placeholder="Enter Comments" id="comments" class="form-control"/>
                                                            <br>
                                                            ...
                                                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                                                  ...
                                                                  <tbody>
                                                                        ...
                                                                        <tr>
                                                                              ...
                                                                              <?php if(user_type()=='1' || user_type()=='2' && in_array('2',user_edit()) || admin_id()!='' && admin_type()=='1')
                                                                              {?>
                                                                              <a href="#javascript:;" onclick="return edit_extras('<?php echo $ex->extra_id; ?>')"  > <!-- Edit-->     </a>
                                                                              <?php } ?>
                                                                              </td>
                                                                              <td>
                                                                              <?php if(user_type()=='1' || user_type()=='2' && in_array('2',user_edit()) || admin_id()!='' && admin_type()=='1')
      ...
      <div id="myModal_autocomplete7" class="modal fade" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                  <div class="modal-content">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        ...
                        <div class="modal-body form">
                              ...
                              <form  class="form-horizontal form-row-seperated" method="POST" action="<?php echo lang_url(); ?>reservation/reservation_changedate/<?php echo insep_encode(($room->reservation_id)); ?>" id="edit_form">

                                    <input type="hidden" name="reserve_id" value="<?php echo $room->reservation_id; ?>">
                                    <input type="hidden" name="Checkinold" value="<?php echo  date('Y-m-d',strtotime(str_replace('/','-',$room->start_date))); ?>">
                                    <input type="hidden" name="Checkoutold" value="<?php echo date('Y-m-d',strtotime(str_replace('/','-',$room->end_date))); ?>">
                                    <input type="hidden" name="ChannelID" value="0">
                                    <input type="hidden" name="Adult" value="<?php echo$room->members_count;?>">
                                    <input type="hidden" name="Child" value="<?php echo $room->children; ?>">
                                    <input type="hidden" name="nights" value="<?php echo $room->num_nights; ?>">
                                    <input type="hidden" name="RoomQTY" value="1">
                                    <input type="hidden" name="RoomID" value="<?= $room->room_id ?>">
                                    <input type="hidden" name="ratedescription" value="">
                                    <input type="hidden" name="RateID" value="<?=$room->rate_types_id ?>">
                                    <input type="hidden" name="RateIDcanal" value="<?=$room->rate_types_id ?>">
                                         ...
                                         <!-- BEGIN FORM-->
                                          ...
                                          <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                      ...
                                                      <div class="col-md-9">
                                                      <input class="form-control" value="<?php echo $room->reservation_code; ?>" type="text" readonly="true" name="ReservationID">
                                                      </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                     <label class="control-label col-md-3">Guest Name <span class="errors"> </span></label>
                                                      <div class="col-md-9">
                                                      <input class="form-control" value="<?php echo $room->guest_name; ?>" type="text" readonly="true" name="guest_name">
                                                      </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                      ...
                                                      <div class="col-md-9">
                                                             <input type="text" class="form-control " id="dp1" name="dp1" value="<?php echo date('d/m/Y',strtotime(str_replace('/','-',$room->start_date)));?>" required> 
                                                ...
                                                <div class="form-group">
                                                      ...
                                                      <div class="col-md-9">
                                                      <input type="text" class="form-control widh" id="dp2" name="dp2"  value="<?php echo date('d/m/Y',strtotime(str_replace('/','-',$room->end_date)));?>" required>
                                                      </div>
                                                </div>  
                                          </div>
                                          <div class="modal-footer">
                              ...
                              <form action="<?php echo lang_url(); ?>reservation/add_extras/<?php insep_encode($room->reservation_id); ?>" method="post" class="form-horizontal form-row-seperated" id="add_extras">
                                    ...
                                    <div class="portlet-body form">
                                          ...
                                          <div class="form-body">
                                                ...
                                                <?php $extras = get_data("room_extras", array("room_id"=>$room->room_id))->result_array();
                                                      ...
                                                      <table class="table">
                                                            <tbody>
                                                                  ...
                                                                  case '1':
                                                                    ...
                                                                    $subtotal = $extraa['price']*intval($room->members_count);
                                                                  break;

                                                                  case '2':
                                                                    $structure = 'Per Night';
                                                                    $subtotal = $extraa['price']*intval($room->num_nights);
                                                                  break;
   ...
   if($('#comments')){
	   if($('#comments').val() != ''){
		   ...
		   $.ajax({
			...
			data:{id,method,can_options,'comments':$('#comments').val()},
...
function delete_extras(id,res,des){
  // alert(res);
 if(confirm('Are you sure want to Delete this Extras Details?')){
    $.ajax({
      type:"POST",
...
function delete_payment(id,value){
  if(confirm('Are You sure want to Delete this Payment Details'))
  {
  $.ajax({
    type:"POST",
