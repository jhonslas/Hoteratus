...
<script type="text/javascript">
    ...
    function del_extra(id) {
        $.ajax({
            url: "<?= lang_url(); ?>inventory/extras/del",
            type: "post",
            data: "id=" + id,
            success: function() {
                $("#extra-" + id).remove();
...
<div class="alert alert-success" style="display:none;" id="suca">
  <button type="button" class="close" data-dismiss="alert">&times;</button>
  <strong>¡Success!</strong> Revenue Active for Room Type: <?php echo $property_name;  ?>.
</div>

<div class="alert alert-warning" style="display:none;" id="sucd">
  <button type="button" class="close" data-dismiss="alert">&times;</button>
  <strong>¡Success!</strong> Revenue DeActive for Room Type: <?php echo $property_name;  ?>.
</div>
...
?>
        ...
        <?php if(user_type()=='1' || user_type()=='2' && in_array('4',user_edit()) || admin_id()!='' && admin_type()=='1'){ ?>
            <p class="few2 text-center pull-left"><a href="<?php echo lang_url();?>channel/manage_rooms/delete/<?php echo insep_encode($property_id);?>" ><i class="fa fa-trash-o text-danger"></i> Delete</a></p>
            <?php } ?>

                <div class="col-md-12 col-sm-4 col-xs-12 cls_resp50">
                    <div class="cls_side_bar">
                        <ul class="list-unstyled clearfix cls_menu_side">
                            <li class="active"><a href="#tab1" data-toggle="tab" role="tab">  Room Configuration </a> </li>
                            <li><a href="#tab4" data-toggle="tab" role="tab">  Rate Configuration </a></li>
                             <li><a href="#tab9" data-toggle="tab" role="tab">  Revenue Manager </a></li>
        ...
        foreach($room_name as $res){ ?>
                                            ...
                                            <option value="<?php echo insep_encode($res->property_id); ?>" <?php if($res->property_id==$property_id){ echo 'selected="selected"';} ?>>
                                                <?php echo $res->property_name; ?>
                                            </option>
                        ...
                        <div id="tab1" class="tab-pane fade in active w3-animate-right" role="tabpanel">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <fieldset style="margin-top:20px;padding: 20px;border: 1px solid;">
										<legend style="border-bottom: 0px solid #e5e5e5;color: #fff;background: #54c5fe;padding: 2px;font-family: sans-serif;">Basic</legend>
                                            ...
                                            <form action="<?php echo lang_url();?>inventory/update_basic_rooms" method="post" id="room_form_<?php echo $property_id?>">
                                                ...
                                                <div class="row">
                                                    <div class="form-group clearfix">
                                                        ...
                                                        <div class="col-sm-6 col-xs-12 cls_resp50">
                                                            <label class="cls_datalabel">Rooms Quantity</label>
                                                            <div class="col-sm-12 col-xs-12 pad-no">
                                                    ...
                                                    <div class="form-group clearfix">
                                                        <div class="col-sm-6 col-xs-12 cls_resp50">
                                                            <label class="cls_datalabel">Rooms Occupancy</label>
                                                            <div class="col-sm-12 col-xs-12 pad-no">
        ...
        " value="<?php echo $room_capacity;?>" step="any" class="form-control txtbox2" name="room_capacity" id="room_capacity" min="1">
                                                    ...
                                                    <div class="form-group clearfix">
                                                        <div class="col-sm-6 col-xs-12 cls_resp50">
                                                            ...
                                                            <div class="col-sm-12 col-xs-12 pad-no">
                                                                <textarea id="description" name="description" class="ckeditor form-control txtbox2">
        ...
        extract($meal);
        ?>
                                                                        <option value="<?php echo $meal_id;?>" <?php if($meal_id==$meal_plan) { ?> selected="selected"
                                                                            <?php  } ?>>
                                                                                <?php echo $meal_name;?>
                                                                        </option>
                                                                        <?php } ?>
        ...
        ?>
							...
							<div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <fieldset style="margin-top:20px;padding: 20px;border: 1px solid;">
										<legend style="border-bottom: 0px solid #e5e5e5;color: #fff;background: #54c5fe;padding: 2px;font-family: sans-serif;">Room Numbers</legend>
                                        <div class="cls_comfrmblk clearfix">
					   ...
					   ?>
						...
						?>
							...
							<div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <fieldset style="margin-top:20px;padding: 20px;border: 1px solid;">
										<legend style="border-bottom: 0px solid #e5e5e5;color: #fff;background: #54c5fe;padding: 2px;font-family: sans-serif;">Extra</legend>
                                        <div class="cls_comfrmblk clearfix">
                                            <div class="cls_comm_in">
												<div class="clearfix">
													<a href="#add_extra" class="cls_com_blubtn pull-right waves-effect waves-light m-r-5 m-b-10" data-animation="sidefall" data-plugin="custommodal" data-overlayspeed="50" data-overlaycolor="#000"><i class="fa fa-plus-circle"></i> Add Extra </a>
												</div>
												<div class="cls_commtable cls_roomtable">
													<div class="table-responsive">
														<table class="table">
															...
															<tbody>
																<?php  
											$extras = get_data('room_extras',array('room_id'=>$property_id));
											foreach ($extras->result() as $row) {
												echo "<tr id='extra-".$row->extra_id."'>";
													echo "<td>".$row->name."</td>";
													echo "<td>".$row->price."</td>";
													switch($row->structure){
														case '1':
															echo "<td>Per Person</td>";
														break;
														case '2':
															echo "<td>Per Night</td>";
														break;
														case '3':
															echo "<td>Per Stay</td>";
														break;
													...
													echo "<td><a href='javascript:del_extra(".$row->extra_id.");'> <i class='fa fa-trash-o text-danger'> </i></a></td> ";
												echo "</tr>";
											}
										?>
															</tbody>
							...
							<div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <fieldset style="margin-top:20px;padding: 20px;border: 1px solid;">
										<legend style="border-bottom: 0px solid #e5e5e5;color: #fff;background: #54c5fe;padding: 2px;font-family: sans-serif;">Amenities</legend>
                                        <div class="cls_comfrmblk clearfix">
...
?>
                                                                <div class="col-md-6 col-sm-6">
                                                                    <?php } ?>
                                                                        ...
                                                                        <div class="">
                                                                            <label>
                                                                                <input type="checkbox" value="<?php echo $amenities_id?>" <?php if(in_array($amenities_id,$get_ammenties)){?> checked="checked"
                                                                                <?php } ?> class="update_amenities" name="update_amenities[]">
 ...
 More </a>
							...
							<div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <fieldset style="margin-top:20px;padding: 20px;border: 1px solid;">
										<legend style="border-bottom: 0px solid #e5e5e5;color: #fff;background: #54c5fe;padding: 2px;font-family: sans-serif;">Photos</legend>
                                        <div class="cls_comfrmblk clearfix">
                                            <div class="row">
				...
				if(user_type()=='1' || user_type()=='2' && in_array('4',user_edit()) || admin_id()!='' && admin_type()=='1'){ ?>
						...
						{
						?>
														      <div class="box-y ui-state-default col-sm-2" style="margin-top: 15px;">
						...
						<img src="data:image/png;base64,<?php echo base64_encode(file_get_contents("uploads/room_photos/".$val));?>" alt="" class="img img-responsive img-thumbnail" id="<?php echo $val; ?>"/></a>
																<?php if(user_type()=='1' || user_type()=='2' && in_array('4',user_edit()) || admin_id()!='' && admin_type()=='1'){ ?>
																	<div class="overbox-y">
                        ...
                        <div id="tab4" class="tab-pane fade w3-animate-right" role="tabpanel">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
									<fieldset style="margin-top:20px;padding: 20px;border: 1px solid;">
										<legend style="border-bottom: 0px solid #e5e5e5;color: #fff;background: #54c5fe;padding: 2px;font-family: sans-serif;">Master Rate</legend>
											<div class="cls_comfrmblk clearfix">
			...
			?>
																			<tr id="item<?php echo $i;?>">
																				<tr>
																					<td class="pa-t-pa-b">
																						<div class="sp"><span class="gray"><?php echo $i;?></span></div>
																					</td>
																					<td class="pa-t-pa-b">
																						...
																						<div class="col-md-3 col-sm-3">
																							<p class="tk" id="total_<?php echo $i;?>">
																								<?php echo $price;?>
																							</p>
																						</div>
																					...
																					<td class="pa-t-pa-b non_refunds <?php if($non_refund=='0'){?> display_none <?php } ?>">
																						...
																						<div class="col-md-3 col-sm-3">
																							<p class="tk" id="n_total_<?php echo $i;?>">
																								<?php echo $price;?>
																							</p>
																						</div>
																					</td>
																				...
																				<tr id="item<?php echo $i;?>">
																					<tr>
																						...
																						<td class="pa-t-pa-b">
																							...
																							<div class="col-md-3 col-sm-3">
																								<select class="form-control" name="method_<?php echo $i;?>" id="method_<?php echo $i;?>">
																									<option value="+" <?php if($method=='+' ) { ?> selected="selected"
																										<?php } ?>> + </option>
																									<option value="-" <?php if($method=='-' ) { ?> selected="selected"
																										<?php } ?>> - </option>
																								</select>
																							...
																							<div class="col-md-3 col-sm-3">
																								<select class="form-control" name="type_<?php echo $i;?>" id="type_<?php echo $i;?>">
																									<option value="Rs" <?php if($type=="Rs" ) { ?> selected="selected"
																										<?php } ?>> Rs </option>
																									<option value="%" <?php if($type=="%" ) { ?> selected="selected"
																										<?php } ?>> %</option>
																								</select>
																							</div>
																							...
																							<div class="col-md-3 col-sm-3">
																								<p class="tk" id="total_<?php echo $i;?>">
																									<?php if($total_amount!='') { echo number_format((float)$total_amount, 2, '.', ','); } else { echo number_format((float)$price, 2, '.', ','); }?>
																								</p>
																							</div>
																						...
																						<td class="pa-t-pa-b non_refunds <?php if($non_refund=='0'){?> display_none <?php } ?>">
																							...
																							<div class="col-md-3 col-sm-3">
																								<select class="form-control" name="n_method_<?php echo $i;?>" id="n_method_<?php echo $i;?>">
																									<option value="+" <?php if($n_method=='+' ) { ?> selected="selected"
																										<?php } ?>>+</option>
																									<option value="-" <?php if($n_method=='-' ) { ?> selected="selected"
																										<?php } ?>>-</option>
																								</select>
																							...
																							<div class="col-md-3 col-sm-3">
																								<select class="form-control" name="n_type_<?php echo $i;?>" id="n_type_<?php echo $i;?>">
																									<option value="Rs" <?php if($n_type=="Rs" ) { ?> selected="selected"
																										<?php } ?>>Rs</option>
																									<option value="%" <?php if($n_type=="%" ) { ?> selected="selected"
																										<?php } ?>>%</option>
																								</select>
																							</div>
																							...
																							<div class="col-md-3 col-sm-3">
																								<p class="tk" id="n_total_<?php echo $i;?>">
																									<?php if($d_total_amount!='') { echo number_format((float)$d_total_amount, 2, '.', ','); } else { echo number_format((float)$price, 2, '.', ','); }?>
																								</p>
																							</div>
																					...
																					<td class="pa-t-pa-b room_baseds">
																						<div class="col-md-3 col-sm-3">
																							<select class="form-control" name="r_n_method_1" id="r_n_method_1">
																								<option value="+" <?php if($sin_rate_details[ 'n_method']=='+' ) { ?> selected="selected"
																									<?php } ?>>+</option>
																								<option value="-" <?php if($sin_rate_details[ 'n_method']=='-' ) { ?> selected="selected"
																									<?php } ?>>-</option>
																							</select>
																						...
																						<div class="col-md-3 col-sm-3">
																							<select class="form-control" name="r_n_type_1" id="r_n_type_1">
																								<option value="Rs" <?php if($sin_rate_details[ 'n_type']=="Rs" ) { ?> selected="selected"
																									<?php } ?>>Rs</option>
																								<option value="%" <?php if($sin_rate_details[ 'n_type']=="%" ) { ?> selected="selected"
																									<?php } ?>>%</option>
																							</select>
																						</div>
																						...
																						<div class="col-md-3 col-sm-3">
																							<p class="tk" id="r_n_total_1">
																								<?php echo $sin_rate_details['d_total_amount'];?>
																							</p>
																						</div>
																					</td>
																				</tr>
																				...
																				<tr id="item0">
																					<tr>
																						...
																						<td class="pa-t-pa-b room_baseds">
																							...
																							<div class="col-md-3 col-sm-3">
																								<p class="tk" id="r_n_total_<?php echo $i;?>">
																									<?php echo $price;?>
																								</p>
																							</div>
																						</td>
			...
			?>
							...
							<div class="row">
                                <div class="col-sm-12 col-xs-12">
									<fieldset style="margin-top:20px;padding: 20px;border: 1px solid;">
										<legend style="border-bottom: 0px solid #e5e5e5;color: #fff;background: #54c5fe;padding: 2px;font-family: sans-serif;">Rate Type</legend>
											<div class="cls_comfrmblk clearfix">
												<?php 
																...
																<table class="table" id="original-container">
																	<thead>
																		...
																		<tr>
																			...
																			<th class="col-md-4">
																				<span class="line"></span> Meal plan
																			</th>
																			<th class="col-md-4">
																				<span class="line"></span> Eligible
																			</th>
																			<th class="col-md-4">
	  ...
	  foreach($rate_types as $rate) { extract($rate); $i++; ?>
																			<tr id="hr_variant_rate_<?php echo insep_encode($uniq_id);?>">
																				...
																				<td>
																					<?php echo get_data(MEAL,array('meal_id'=>$meal_plan))->row()->meal_name;?>
																				</td>
																				<td>
																					<?php if($droc=='1') { ?>Yes
																						<?php } else { echo 'No';}?>
																				...
																				<?php  if(user_type()=='1' || user_type()=='2' && in_array('4',user_edit()) || admin_id()!='' && admin_type()=='1'){ ?>
																					<td>
																						<a href="javascript:;" title="Delete this rate type" class="del_rate" data-id="<?php echo insep_encode($uniq_id);?>" room-id="<?php echo insep_encode($room_id);?>"> <i class="fa fa-trash-o text-danger"> </i></a>
																					</td>
																					<?php }
	  else {?>
																						<td>
																							<a href="javascript:;"> <i class="fa fa-trash-o text-danger"> </i></a>
																						</td>
																						<?php }
	  ?>
																			</tr>
            ...
            <p class="grhead"> <?php echo $channels->channel_name;?> </p>
                                    ...
                                    <?php } } } else { ?>
                                        ...
                                        <div class="bb1">
                                            <br>
                                            <div class="reser">
                                                <center><i class="fa fa-globe"></i></center>
                                            </div>
...
<!-- photos end -->
                         <div id="tab9" class="tab-pane fade w3-animate-right" role="tabpanel">
                            <div class="row"  >
                                 <h3 > Revenue Status </h3>
                                <label class="switch" > 
                                  <input type="checkbox" onchange="change_revenue('1','<?php echo $property_id  ?>',this.checked)"  <?php echo ($revenuertatus=='1'?'checked':'');  ?> name="RevenueStatus" id="RevenueStatus"  > 
                                  <span class="slider round"></span>
                                </label>
                            </div>

                                 <h3 > Revenue Configurations </h3>

                                 <div class="col-md-6 col-sm-6 col-xs-12 cls_resp50">
                                     <div class="form-group">
                                        <label class="col-sm-6 control-label" for="percentage">Percentage of Increase  <i class="fa fa-exclamation-circle"></i></label>
                                        <div class="col-sm-6">
                                            <input type="number" onblur="change_revenue('3','<?php echo $property_id  ?>',this.value)" value="<?php echo $percentage;?>" step="any" class="form-control txtbox2" name="percentage" id="percentage" min="1" max="100">
                                        </div>
                                    </div>
                                   
                                    <br>  <br>
                                     <div class="form-group">
                                     <label class="col-sm-6 control-label" for="maximun">Maximum Price Increase <i class="fa fa-exclamation-circle"></i></label>
                                    <div class="col-sm-6">
                                        <input type="number" onblur="change_revenue('2','<?php echo $property_id  ?>',this.value)" value="<?php echo $maximun;?>" step="any" class="form-control txtbox2" name="maximun" id="maximun" min="1" >
                                    </div>
                                </div>
...
?>
 ...
 ICAL LINK : <div style="color:#659BE0"><?php echo base_url().'uploads/ICAL/room/'.$available['ical_link'];?></div>
...
?>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <?php } ?>
                                            <div class="">
                                                <label>
                                                    <input type="checkbox" value="<?php echo $amenities_id?>" <?php if(in_array($amenities_id,$get_ammenties)){?> checked="checked"
                                                    <?php } ?>name="update_amenities[]" class="update_amenities_modal">
                                                        <?php echo $amenities_name;?>
                                                </label>
                                            </div>
                                            <?php $a++; if($a%4==0){ ?>
                                    </div>
                                    <?php } else { if($j==$values){?>
                            </div>
                            <?php } } }  ?>
                        </div>
                    </div>
    ...
    <?php } ?>
        ...
        foreach($selling as $sell=>$key) { ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" value="1" <?php if($droc==1) { ?> checked="checked"
                                                <?php } ?> name="droc" id="droc">
                                            </label>
                                        </div>
                                    </div>
                                </div>
        ...
        <div id="add_extra" class="modal-demo modal-dialog modal_list modal-content">
            <button type="button" class="close login_close" onclick="Custombox.close();">
                <span>&times;</span><span class="sr-only">Close</span>
            </button>
            <h4 class="custom-modal-title">Add Extra Services</h4>
            <hr>
            <div class="custom-modal-text">
                <form action="<?php echo lang_url();?>inventory/extras/add" id="add_extra_form" method="POST">
                    <div class="row">
                        <div class="col-sm-6">
                            <label for="service">Service Name<span class="errors">*</span></label>
                            <input class="form-control" type="text" name="name">
                        </div>
						<div class="col-sm-6">
                            <label for="price">Price<span class="errors">*</span></label>
					...
					<div class="row">
                        <div class="col-sm-6">
                            <label for="taxes">Taxes %<span class="errors">*</span></label>
                            <input class="form-control" type="text" name="taxes">
                        </div>
						<div class="col-sm-6">
                            <label for="structure">Price Structure<span class="errors">*</span></label>
							<br>
                    ...
                    <input type="hidden" name="room_id" value="<?php echo insep_encode($property_id);?>">

                    <input type="submit" id="add_extra_submit" style="margin-top:0px;" class="cls_com_blubtn hover-shadow pull-right" value="Submit" />
                </form>
            </div>
        </div>
  ...
  <?php echo get_data(CONFIG)->row()->company_name;?> Add Tax Categories</h4>
      ...
      ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="radio" value="1" checked="checked" name="droc" id="droc" /> Yes
                                    <input type="radio" value="2" name="droc" id="droc1" /> No
                                </div>
                            </div>
                            <div class="clearfix"></div>
                                                ...
                                                <tr id="item<?php echo $i;?>">
                                                    <tr>
                                                        ...
                                                        <td class="pa-t-pa-b">
                                                            ...
                                                            <div class="col-md-3 col-sm-3">
                                                                <p class="tk" id="r_t_total_<?php echo $i;?>">
                                                                    <?php echo number_format((float)get_data(TBL_PROPERTY,array('property_id'=>$property_id))->row()->price,2, '.', '');?>
                                                                </p>
                                                            </div>
                                                        </td>
                                                        <td class="pa-t-pa-b non_refund  display_none ">
                                                            ...
                                                            <div class="col-md-3 col-sm-3">
                                                                <p class="tk" id="r_t_n_total_<?php echo $i;?>">
                                                                    <?php echo number_format((float)get_data(TBL_PROPERTY,array('property_id'=>$property_id))->row()->price,2, '.', '');?>
                                                                </p>
                                                            </div>
                                                        </td>
...
<script>
var roomid = '<?php echo $property_id;?>';
 $( function() {
    $('#uk-sortable').sortable( { 
        revert    : true,
        connectWith  : "#uk-sortable",
        stop     : function(event,ui){ 
            var images = '';
            $('#img_rplae img').each(function(){
                if($(this).attr('id') != undefined){
                    images += $(this).attr('id')+',';
                }
                
            });
            $.post('../../saveImagesOrders',{'image_det':images,'roomid':roomid});
        }
    });    
  });

 function change_revenue(opt,room_id,valor)
{       
  ...
  {     
        ...
        var roomcaount = $("#existing_room_counts").val();

        if((roomcaount<3 || roomcaount =="") && valor==true)
        {
            $('#alert1').toggle("slow"); 
            $('#RevenueStatus').prop('checked', false);
            return;
        }

        if((percen==0 || percen=="") && valor==true)
        {
            alert('The percentage of increase must be greater than zero to activate revenue');
            $('#RevenueStatus').prop('checked', false);
            return;
        }
         if((maxi==0 || maxi=="") && valor==true)
        {
            alert('Maximum price must be greater than zero to activate revenue');
            $('#RevenueStatus').prop('checked', false);
            return;
        }
        ...
        $.ajax({
        type: "POST",
        url: base_url+'reservation/change_room_revenue',
        data:{"opt":opt,"id":room_id,"revenuertatus":(valor==true?1:0),"percentage":percen,"maximun":maxi,"minimun":mini,},
  ...
  else 
  {
         ...
         if((maxi !=0 && maxi !="" && opt ==2) || (percen !=0 && percen !="" && opt==3) || (mini !=0 && mini !="" && opt==4)  )
        {
             $.ajax({
                        type: "POST",
                        url: base_url+'reservation/change_room_revenue',
                        data:{"opt":opt,"id":room_id,"valor":valor,},
                        success: function(result)
                        {
                            $("#preloader").fadeOut("slow");  
                            $('#suc').toggle(); 
